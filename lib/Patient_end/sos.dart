  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        scaffoldBackgroundColor: const Color(0xFFC5D4E5), // Light pink background
      ),
      home: HomeScreen(),
    );
  }
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              const Color(0xFFC5D4E5)!,
              const Color(0xFF007069)!,
            ], // Light pink gradient
          ),
        ),
        child: Center(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.symmetric(vertical: 20, horizontal: 40),
                    backgroundColor: const Color(0xFF007069), // Dark pink button color
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(
                        30,
                      ), // Rounded corners
