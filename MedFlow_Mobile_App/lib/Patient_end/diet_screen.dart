...
class _PatientDietScreenState extends State<PatientDietScreen> {
  ...
  Future<List<DietSuggestion>> _fetchSuggestionsFromGemini(int month) async {
    ...
    final String prompt = '''
    You are a  nutrition expert. Your knowledge is based STRICTLY on guidelines from healthychildren.org (American Academy of Pediatrics).
    provide 5 distinct dietary suggestions focusing on key nutrients for that stage.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xFF007069), // Set background to black
          ...
          children: [
            ...
            if (_errorMessage != null)
              Center(
                child: Text(
                  _errorMessage!,
                  style: const TextStyle(color: Color.fromARGB(255, 4, 0, 0)),
                ),
              ),
    ...
    return Form(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: const Color(((0xFFC5D4E5))).withOpacity(0.1),
              blurRadius: 10,
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                foregroundColor: const Color((0xFFC5D4E5)),
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color((0xFF007069))),
          ),
          child: Text(
  ...
  Widget _buildSuggestionCard(DietSuggestion suggestion) {
    return Card(
      ...
      elevation: 3,
      shadowColor: const Color(((0xFFC5D4E5))).withOpacity(0.2),
